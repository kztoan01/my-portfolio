...
export default function Home() {
  ...
  const works = [
    {
      img: 'https://storage.cloud.google.com/arthub-bucket/ArtHub-only-logo.png',
      company: 'ArtHub',
      role: 'Founder/CEO',
      start: '2023',
      end: 'Present'
    ...
    {
      img: 'https://rubicmarketing.com/wp-content/uploads/2022/07/y-nghia-logo-fpt-lan-3.jpg',
          ...
          <div className="relative px-4 sm:px-8 lg:px-12">
            <div className="mx-auto max-w-2xl lg:max-w-5xl flex">
              <div className="max-w-2xl">
                ...
                <p className="leading-7 mt-6 text-base text-zinc-600 dark:text-zinc-400">I’m Toan,
                  a full-stack software engineer
                  and conqueror based in Ho Chi Minh City. I’m the founder and CEO of ArtHub, where we
                  provides drawing courses for everyone posted by many instructors.
                </p>
              ...
              <div className="mx-auto grid max-w-xl grid-cols-1 gap-y-20 lg:max-w-none lg:grid-cols-2">
                ...
                <div className="space-y-10 lg:pl-16 xl:pl-24">
                  ...
                  <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
                    ...
                    </ol><a href='https://drive.google.com/file/d/1R4U362QVM0RHatl8aXwgCa6ZjSYl-mTU/view?usp=sharing' target="_blank"
