                    ...
                    <div className="relative px-4 sm:px-8 lg:px-12">
                        <div className="mx-auto max-w-2xl lg:max-w-5xl flex">
                            <div className="max-w-2xl">
                                ...
                                <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">I’m Toan, a software designer
                                    and conqueror based in Ho Chi Minh City. I’m the founder and CEO of ArtHub, where we
                                    develop technologies that empower regular people to explore space on their own terms.
                                </p>
                                <div className="mt-6 flex gap-6">
                                    <a className="group -m-1 p-1" aria-label="Follow on Twitter"
                                        href="https://twitter.com/yothatstoan">
                                    ...
                                    <a className="group -m-1 p-1" aria-label="Follow on Instagram"
                                        href="https://www.instagram.com/yothats.toan/?hl=en">
                                        <svg viewBox="0 0 24 24" aria-hidden="true"
                                            className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                                            <path
                                    ...
                                    <a className="group -m-1 p-1" aria-label="Follow on GitHub"
                                        href="https://github.com/kztoan01"><svg viewBox="0 0 24 24" aria-hidden="true"
                                            className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                                            ...
                                            <div
                                                ...
                                                href="/articles/crafting-a-design-system-for-a-multiplanetary-future"><span
                                                    className="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl"></span><span
                                                        className="relative z-10">Crafting a design system for a multiplanetary
                                                    future</span></a>
                                        </h2><time
                                            ...
                                            <li className="flex gap-4">
                                                ...
                                                <dl className="flex flex-auto flex-wrap gap-x-2">
                                                    ...
                                                    <dd className="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                                                        aria-label="2019 until Present"><time>2023</time>
                                            ...
                                            <li className="flex gap-4">
                                                ...
                                                <dl className="flex flex-auto flex-wrap gap-x-2">
                                                    ...
                                                    <dd
                                                        ...
                                                        Airbnb</dd>
                                                    <dt className="sr-only">Role</dt>
                                                    <dd className="text-xs text-zinc-500 dark:text-zinc-400">Product Designer
                                                    </dd>
                                                    <dt className="sr-only">Date</dt>
                                                    <dd className="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                                                        aria-label="2014 until 2019"><time>2014</time> <span
                                                            aria-hidden="true">—</span> <time>2019</time>
                                                    </dd>
                                                </dl>
                                            </li>
                                            <li className="flex gap-4">
                                                ...
                                                <dl className="flex flex-auto flex-wrap gap-x-2">
                                                    ...
                                                    <dd
                                                        ...
                                                        Facebook</dd>
                                                    <dt className="sr-only">Role</dt>
                                                    <dd className="text-xs text-zinc-500 dark:text-zinc-400">iOS Software
                                                        Engineer</dd>
                                                    <dt className="sr-only">Date</dt>
                                                    <dd className="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                                                        aria-label="2011 until 2014"><time>2011</time> <span
                                                            aria-hidden="true">—</span> <time>2014</time>
                                                    </dd>
                                                </dl>
                                            </li>
                                            <li className="flex gap-4">
                                                <div
                                                    ...
                                                    <img alt="" loading="lazy" width="28" height="28" decoding="async"
                                                        data-nimg="1" className="h-7 w-7 object-cover object-center rounded-full"
                                                        src="https://upload.wikimedia.org/wikipedia/vi/thumb/d/d3/Starbucks_Corporation_Logo_2011.svg/800px-Starbucks_Corporation_Logo_2011.svg.png"
                                                    /></div>
                                                <dl className="flex flex-auto flex-wrap gap-x-2">
                                                    <dt className="sr-only">Company</dt>
                                                    <dd
                                                        ...
                                                        Starbucks</dd>
                                                    <dt className="sr-only">Role</dt>
                                                    <dd className="text-xs text-zinc-500 dark:text-zinc-400">Shift Supervisor
                                                    </dd>
                                                    <dt className="sr-only">Date</dt>
                                                    <dd className="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                                                        aria-label="2008 until 2011"><time>2008</time> <span
                                                            aria-hidden="true">—</span> <time>2011</time>
                                                    </dd>
                                                </dl>
                                            </li>
                                        </ol><a
